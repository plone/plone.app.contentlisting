...
setup_product()
ptc.setupPloneSite(products=['plone.app.contentlisting'])


class ContentlistingTestCase(ptc.PloneTestCase):
...
class ContentlistingFunctionalTestCase(ptc.FunctionalTestCase):
